...
plans = [
    Plan(id=uuid4(), name="free",  price_in_cents=0, max_subjects_per_experiment=5000, max_active_experiments=3, schedule_id=None, public=True, self_serve=True),

    Plan(id=uuid4(), name="developer",  price_in_cents=100*500, max_subjects_per_experiment=50000, max_active_experiments=10, schedule_id=monthly_schedule_id, public=True, self_serve=True),

    Plan(id=uuid4(), name="developer",  price_in_cents=100*500*10, max_subjects_per_experiment=50000, max_active_experiments=10, schedule_id=annual_schedule_id, public=True, self_serve=True),

    Plan(id=uuid4(), name="team",  price_in_cents=100*1500, max_subjects_per_experiment=100000, max_active_experiments=25, schedule_id=monthly_schedule_id, public=True, self_serve=True),
