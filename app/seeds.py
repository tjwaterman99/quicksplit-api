...
plans = [
    ...
    Plan(id=uuid4(), name="developer",  price_in_cents=100*50, max_subjects_per_experiment=50000, max_active_experiments=10, schedule_id=monthly_schedule_id),
    Plan(id=uuid4(), name="team",  price_in_cents=100*250, max_subjects_per_experiment=100000, max_active_experiments=25, schedule_id=monthly_schedule_id),
